...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="file_req.jsp"><span>File Request</span></a></li>
          <li><a href="user_de.jsp"><span>Security Device issue</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
         <!--  start body--->
<br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">FILE REQUEST</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            <th style="text-align: center;width: 200px; font-size: 16px; color: black">No</th>
                            ...
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: blue">Send SPK</th>
                        </tr>
                        <tr>
                            <%
                                Connection con = null;
                            ...
                            <td style="font-size: 16px"><%=rs.getString("fname")%></td> 
                             <td><a href="mail.jsp?<%=rs.getString("id")%>"><font style="color: green; font-size: 16px">Send</a></td>
                        </tr>
                        <%
