...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
            ...
            %>
            <script>alert('File Request sent Success');</script>
            <%            }
            %>
    </head>
    <body>
        <div class="main">
                ...
                <div class="header_resize">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li class="active"><a href="file_de1.jsp"><span>File Details</span></a></li>
                            <li><a href="down.jsp"><span>File Access</span></a></li>
            ...
            <div class="content">
                <div class="content_resize">
                    ...
                    <!--  start body--->
                    <br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">FILE DETAILS</h2>
                            <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                                    <tr>
                                        ...
                                        <th style="text-align: center;width: 200px;  font-size: 16px; color: darkred">Request</th>
                                    </tr>
                                    <tr>
                                        <%
                                        ...
                                        System.out.println("Policy De : "+spol);
                                            ...
                                            try {
                                                ...
                                                rs = st.executeQuery("select * from upload where policy LIKE '%" + spol + "%'");
                                                while (rs.next()) {
                                        %>
                                        ...
                                        <td><a href="request.jsp?fname=<%=rs.getString("filename")%>&skey=<%=rs.getString("skey")%>"><font style="color: green; font-size: 16px">Send</a></td>
                                    </tr>
                                    <%
