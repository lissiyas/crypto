        ...
        <div class="main">
                ...
                <div class="header_resize">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li><a href="owner.jsp"><span>Data Owner</span></a></li>
                            <li class="active"><a href="user.jsp"><span>Data Receivers</span></a></li>
            ...
            <div class="content">
                <div class="content_resize">
                    <div class="mainbar">
                        <div class="article">
                            <h2><span>DATA RECEIVER LOGIN</span></h2>
                                    ...
                                    <form action="loginaction.jsp" method="get">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="submit" class="button" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="font-family: fantasy; font-size: 20px" href="reg.jsp">New User</a></td>
                                            </tr>
                                        </table>
                                    </form>
                                </div>
