        ...
        <div class="main">
            ...
            <div class="content">
                <div class="content_resize">
                    ...
                    <!--  start body--->
                    <br><br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">FILE DOWNLOAD</h2>
                                <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                                        ...
                                        <tr>
                                            <%
                                                ...
                                                Statement st = null;
                                                ResultSet rs = null;
                                                String skey = (String) session.getAttribute("skkey");
                                                try {
                                                    con = DbConnection.getConnection();
                                                    st = con.createStatement();
                                                    rs = st.executeQuery("select * from upload where skey='" + skey + "'");
                                                    while (rs.next()) {
                                            %>
                                            ...
                                            <td><a href="Download?<%=rs.getString("id")%>"><font style="color: green; font-size: 16px">Click</a></td>
                                        </tr>
                                        <%
