...
public final class download_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<head>\n");
      out.write("<title>File Details</title>\n");
      ...
      out.write("        <ul>\n");
      out.write("          <li><a href=\"userhome.jsp\"><span>User Home</span></a></li>\n");
      out.write("          <li><a href=\"file_de1.jsp\"><span>File Details</span></a></li>\n");
      out.write("          <li class=\"active\"><a href=\"down.jsp\"><span>File Access</span></a></li>\n");
      ...
      out.write("<br><br><center><h2 style=\"font-size: 26px; color: deepskyblue; font-family: cursive\">FILE DOWNLOAD</h2>\n");
      ...
      out.write("                            <th style=\"text-align: center;width: 200px;  font-size: 16px; color: blue\">Download</th>\n");
      out.write("                        </tr>\n");
      out.write("                        <tr>\n");
      out.write("                            ");
                                ...
                                Statement st = null;
                                ResultSet rs = null;
                                String skey= (String)session.getAttribute("sskey");
                                try {
                                    con = DbConnection.getConnection();
                                    st = con.createStatement();
                                    rs = st.executeQuery("select * from upload where skey='4Z4ZysiQaaAMk9xU2/GAZVztIzrNf1MbWyeT+YdXDn/WLEZ23lbJ0Q=='");
                                    while (rs.next()) {
      ...
      out.write("</td>  \n");
      out.write("                            <td style=\"font-size: 16px\">");
      out.print(rs.getString("dataprovider"));
      out.write("</td>  \n");
      out.write("                            <td style=\"font-size: 16px\">");
      ...
      out.print(rs.getString("id"));
      out.write("\"><font style=\"color: green; font-size: 16px\">Click</a></td>\n");
      out.write("                        </tr>\n");
      out.write("                        ");
