    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="user.jsp"><span>Back</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
          ...
          <form action="loginaction.jsp" method="get">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <th>Access Policy : </th>
                                        <td>
                                            <select class="inputss" name="policy" required="" > 
                                               <option value="">Select Attributes</option> 
                                                <option value="Cloud Computing">Cloud Computing</option> 
                                                <option value="Networking">Networking</option> 
                                                <option value="Secure Computing">Secure Computing</option> 
                                    ...
                                    <tr>
                                        <td><input type="hidden" name="status" value="4" /></td>
