...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
                if (request.getParameter("spk") != null) {
            %>
            <script>alert('Secret Part Key is Not Matched');</script>
            <%            }
            %>
        <%
                if (request.getParameter("sdkeror") != null) {
            %>
            <script>alert('Device Not Found');</script>
            <%            }
            %>
        <%
                if (request.getParameter("sdkeror") != null) {
            %>
            <script>alert('The system cannot find the file specified');</script>
            <%            }
            %>
        <style> 
        ...
        <div class="main">
                ...
                <div class="header_resize">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li><a href="file_de1.jsp"><span>File Details</span></a></li>
                            <li class="active"><a href="down.jsp"><span>File Access</span></a></li>
            ...
            <div class="content">
                <div class="content_resize">
                    <div class="mainbar">
                        <div class="article">
                            <h2><span>Verify SPK and SDK</span></h2>
                            ...
                            <div id="content">
                                <div id="left">
                                    <form action="verification.jsp" method="get">
                                        <table>
                                            <tr>
                                                <td><br><br><br><input type="password" name="verify" class="inputs" placeholder="SPK Verification Code" required=""/></td>
                                            </tr>
                                            <tr>
                                ...
                                <div id="right">
                                    <img src="images/verify.jpg" width="250" height="200" />
                                </div>
                            </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="gadget">
                            ...
                            <ul class="sb_menu">
                                ...
                                <li><a href="down.jsp">File Access</a></li>
