...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="cahome.jsp"><span>CA Home</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>CA HOME PAGE</span></h2>
          <p class="infopost">Cloud Storage <span class="date"></span></p>
          <p>
              <center><img src="images/ca1.jpg" width="500" height="200" /></center>
          </p>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="cahome.jsp">CA Home</a></li>
            <li><a href="file_req.jsp">File Request</a></li>
            <li><a href="user_de.jsp">File Access</a></li>
